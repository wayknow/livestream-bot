...
```
指标                   |  基座模型  |  SFT v2  |  SFT v5  |  目标值
-----------------------|-----------|----------|----------|--------
互动密度(句)           |   0.047   |   0.110  |   0.243↑ |   >0.4
平均句长(字)           |  29.967   |  15.080  |   6.920↓ |   <15
口语词占比             |   0.003   |   0.016  |   0.028↑ |   >0.15
结构完整度(0-5)        |   3.000   |   4.400  |   4.200  |   >4.0
卖点覆盖率             |   0.889   |   1.000  |   1.000  |   >0.85
幻觉率                 |   0.000   |   0.025  |   0.000↓ |   <0.05
情绪递进得分           |   4.333   |   3.480  |   3.000  |   >3.5
流畅度得分             |   3.000   |   4.000  |   5.000↑ |   >3.5
```
