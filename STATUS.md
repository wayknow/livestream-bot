...
基于 QLoRA + KTO 的直播带货话术生成器，24GB Mac Mini 本地可跑。**项目已完成，KTO 模型最适合有实时互动的数字人直播场景，8/8 评估指标达标。**
...
1. ✅ **互动密度最高**：0.304（目标 0.3-0.4，完美匹配）
2. ✅ **口语化最好**：0.046（目标 >0.03，达标）
3. ✅ **结构最清晰**：4.60（目标 >4.0，达标）
4. ✅ **卖点覆盖合理**：0.800（目标 0.6-0.8，正好在范围内）
...
|------|-----|-----|----------|------|
| 互动密度 | 0.181 | **0.304** | ✅ +68% | 0.3-0.4 |
| 平均句长 | 7.28 | 16.34 | ✅ 达标 | 15-20 |
| 口语词占比 | 0.022 | **0.046** | ✅ +109% | >0.03 |
| 结构完整度 | 4.40 | **4.60** | ✅ +5% | >4.0 |
| 卖点覆盖率 | 0.833 | **0.800** | ✅ 正好 | 0.6-0.8 |
| 幻觉率 | 0.000 | 0.000 | ✅ 平手 | <0.05 |
| 情绪递进 | 3.70 | **3.98** | ✅ +8% | >3.5 |
| 流畅度 | **5.00** | 3.60 | ⚠️ DPO 胜 | >3.5 |
...
| 指标 | 基座 | KTO | 目标 | 状态 |
|------|------|-----|------|------|
| 互动密度 | 0.047 | **0.304** | 0.3-0.4 | ✅ 完美匹配 |
| 平均句长 | 29.97 | **16.34** | 15-20 | ✅ 达标 |
| 口语词占比 | 0.003 | **0.046** | >0.03 | ✅ 达标 |
...
| 指标 | 无互动数字人 | 有互动数字人 | 说明 |
|------|-------------|-------------|------|
| 互动密度 | 0.2-0.25 | **0.3-0.4** | 可以实时互动，应该更高 |
| 卖点覆盖率 | 0.6-0.8 | **0.6-0.8** | 可以穿插互动，不需要全覆盖 |
| 平均句长 | <15 | **15-20** | 讲卖点时正常长度 |
...
1. **优化平均句长**：从 16.34 微调到 15-18
2. **优化流畅度**：从 3.60 提升到 4.0+
