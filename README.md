...
| 指标 | 基座 | SFT v7 | 目标 | 状态 |
|------|------|--------|------|------|
| 互动密度 | 0.047 | 0.181 | >0.2 | ⚠️ 接近 |
| 平均句长 | 29.97 | 7.28 | <15 | ✅ 达标 |
| 口语词占比 | 0.003 | 0.022 | >0.02 | ✅ 达标 |
| 结构完整度 | 3.00 | 4.40 | >4.0 | ✅ 达标 |
| 卖点覆盖率 | 0.889 | 0.833 | >0.85 | ⚠️ 接近 |
| 幻觉率 | 0.000 | 0.000 | <0.05 | ✅ 达标 |
| 情绪递进 | 4.33 | 3.70 | >3.5 | ✅ 达标 |
| 流畅度 | 3.00 | 5.00 | >3.5 | ✅ 达标 |
