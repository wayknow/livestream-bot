...
|------|------|-----|-----|------|----------|
| 互动密度 | 0.047 | 0.181 | **0.304** | 0.3-0.4 | ✅ KTO 高 68% |
| 平均句长 | 29.97 | 7.28 | **16.34** | 15-20 | ✅ KTO 达标 |
| 口语词占比 | 0.003 | 0.022 | **0.046** | >0.03 | ✅ KTO 高 109% |
| 结构完整度 | 3.00 | 4.40 | **4.60** | >4.0 | ✅ KTO 高 5% |
| 卖点覆盖率 | 0.889 | 0.833 | 0.800 | 0.6-0.8 | ⚠️ DPO 更高 |
| 幻觉率 | 0.000 | 0.000 | 0.000 | <0.05 | ✅ 平手 |
| 情绪递进 | 4.33 | 3.70 | **3.98** | >3.5 | ✅ KTO 高 8% |
| 流畅度 | 3.00 | **5.00** | 3.60 | >3.5 | ⚠️ DPO 更流畅 |
| 内存占用 | 15.3 GB | 15.3 GB | **12.5 GB** | - | ✅ KTO 省 18% |

**KTO vs DPO 对比**：
- ✅ **KTO 互动密度高 68%**：0.304 vs 0.181（更有直播感）
- ✅ **KTO 口语化高 109%**：0.046 vs 0.022（更自然）
- ✅ **KTO 结构更清晰**：4.60 vs 4.40（更适合数字人）
- ✅ **KTO 情绪递进强**：3.98 vs 3.70（节奏更好）
- ✅ **KTO 卖点覆盖合理**：0.800 vs 0.833（DPO 超出范围，KTO 正好）
- ✅ **KTO 最省显存**：12.5 GB vs 15.3 GB（省 18%）
- ⚠️ DPO 流畅度更高：5.00 vs 3.60
- ⚠️ DPO 句子更短：7.28 vs 16.34

**推荐**：**KTO 更适合有实时互动的数字人直播**，因为互动密度高、口语化好、卖点覆盖合理、最省显存。
