...
STYLES = [
    ...
    },
    {
        ...
        "互动词": ["有没有同感", "是不是这样", "对不对", "是不是特别烦", "同款扣1"],
        "口头禅": ["想象一下", "你有没有", "真的", "太真实了", "就是这样"]
    },
    {
        "name": "悬念开场型",
        "特征": "先制造悬念，再揭晓答案",
        ...
        "互动词": ["猜猜看", "你们猜", "有没有猜到", "对不对", "是不是"],
        "口头禅": ["你们猜", "秘密", "原来", "发现了", "公开"]
    },
    {
        "name": "情感共鸣型",
        "特征": "先共情，再推荐，情感连接强",
        "patterns": [
            ...
            "是不是每次{scene}都特别烦？",
            "我之前也是这样！",
            "直到遇到{product}，{solution}！",
            "现在{price}，你值得拥有！"
        ],
        "互动词": ["有没有同感", "是不是特别烦", "我懂", "同款扣1", "对不对"],
        "口头禅": ["我懂", "我之前也是", "你值得", "真的", "太懂了"]
    }
]
